...
class mysql{
	...
	private function connentMysql(){
		$this->link = mysql_connect($this->host,$this->user,$this->passwd,$this->db,$this->port) or die('mysql connent fail');
	}
	private function selectDb(){
		$sql = "use ".$this->db;
		$this->result = mysql_query($this->link,$sql);
	}
	...
	public function mysqlGetRows(){
	    ...
	    while ($re = mysql_fetch_assoc($this->result)) {
	        $data[]= $re;
	    }
	    return $data;
	}
